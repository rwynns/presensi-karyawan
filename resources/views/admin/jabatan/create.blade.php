    ...
    <div class="main-container min-h-screen bg-gray-50 overflow-y-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 min-h-full overflow-visible">
            ...
            <div class="flex items-center space-x-2 mb-6">
                ...
                <h1 class="font-bold text-2xl text-gray-900">Tambah Jabatan</h1>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Masukkan informasi jabatan dengan kode yang unik</p>
                </div>

                <form id="jabatanForm" action="{{ route('admin.jabatan.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="max-w-2xl space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_jabatan" id="kode_jabatan"
                                ...
                                value="{{ old('kode_jabatan') }}" placeholder="Contoh: MGR, SPV, STF" maxlength="20"
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_jabatan" id="nama_jabatan"
                                ...
                                value="{{ old('nama_jabatan') }}" placeholder="Contoh: Manager, Supervisor, Staff"
                    ...
                    <div class="mt-8 flex items-center justify-between pt-6 border-t border-gray-200">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button type="submit" id="submitButton"
                                class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7"></path>
                                </svg>
                                <span id="submitText">Simpan Jabatan</span>
                            </button>
                        </div>
                    </div>
                </form>
